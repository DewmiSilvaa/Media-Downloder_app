...
import { Download as DownloadIcon, Youtube, Facebook, Instagram, MessageCircle, X, Mail, Globe, Phone, Loader2 } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex justify-center space-x-4 mb-8">
          {Object.entries(platforms).map(([key, { name, icon: Icon, color }]) => (
            <button
              key={key}
              onClick={() => setActiveTab(key as keyof typeof platforms)} // Ensure type matches
